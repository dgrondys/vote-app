    ...
    >
        ...
        @if ($notifications->isNotEmpty() && ! $isLoading)
            ...
            <li>
                ...
                >
                    <img src="/uploads/avatars/{{ $notification->data['user_avatar'] }}" class="rounded-xl w-10 h-10" alt="avatar">
                    <div class="ml-4">
                        <div class="line-clamp-6">
                            <span class="font-semibold">{{ $notification->data['user_name'] }}</span> skomentował
        ...
        @else
            <li class="mx-auto w-40 py-6">
                ...
                <div class="text-gray-400 text-center font-bold mt-4">Brak nowych powiadomień</div>
            </li>
        @endif
    </ul>
</div>